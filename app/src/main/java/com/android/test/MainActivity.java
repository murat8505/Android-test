        ...
        JsonArrayRequest request = new JsonArrayRequest(URL,
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        if (response == null) {
                            Toast.makeText(getApplicationContext(), "Couldn't fetch the response! Pleas try again.", Toast.LENGTH_LONG).show();
                            return;
                        }
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(getApplicationContext(), "Error: " + getString(R.string.error), Toast.LENGTH_SHORT).show();
            }
        });
